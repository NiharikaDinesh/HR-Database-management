...
public class Project extends JFrame implements ActionListener {
    ...
    Project(){
        ...
        ImageIcon i1 = new ImageIcon("C:\\Users\\dinesh\\Documents\\NetBeansProjects\\PayrollSystem\\src\\payrollsystem\\proj.jpg");
       ...
       t1.setIcon(new ImageIcon(ClassLoader.getSystemResource("payrollsystem/icons/New.png")));
        ...
        t3.setMnemonic('S');
       t3.setIcon(new ImageIcon(ClassLoader.getSystemResource("payrollsystem/icons/schedreport.png")));
        ...
        t4.setMnemonic('L');
        t4.setIcon(new ImageIcon(ClassLoader.getSystemResource("payrollsystem/icons/newinvoice.png")));
      ...
      //  t2.addActionListener(this);
        ...
        s1.setMnemonic('U');
        s1.setIcon(new ImageIcon(ClassLoader.getSystemResource("payrollsystem/icons/EditOpen.png")));
        ...
        s2.setMnemonic('E');
    s2.setIcon(new ImageIcon(ClassLoader.getSystemResource("payrollsystem/icons/empreport.png")));
        s2.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_E, ActionEvent.CTRL_MASK));
        ...
        s3.setMnemonic('T');
       s3.setIcon(new ImageIcon(ClassLoader.getSystemResource("payrollsystem/icons/EXPENSE.PNG")));
        ...
        p1.setMnemonic('P');
        p1.setIcon(new ImageIcon(ClassLoader.getSystemResource("payrollsystem/icons/payments.png")));
        ...
        p2.setMnemonic('A');
        p2.setIcon(new ImageIcon(ClassLoader.getSystemResource("payrollsystem/icons/empreport.png")));
        p2.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_A, ActionEvent.CTRL_MASK));
        ...
        u1.setIcon(new ImageIcon(ClassLoader.getSystemResource("payrollsystem/icons/New.png")));
        ...
        u2.setIcon(new ImageIcon(ClassLoader.getSystemResource("payrollsystem/icons/calc.png")));
        ...
        u3.setIcon(new ImageIcon(ClassLoader.getSystemResource("payrollsystem/icons/explorer.jpg")));
        ...
        m8i1.setMnemonic('X');
        m8i1.setIcon(new ImageIcon(ClassLoader.getSystemResource("payrollsystem/icons/exit.PNG")));
